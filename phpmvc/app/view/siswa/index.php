<div class="container mt-5">
 ...
 <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php foreach($data['siswa'] as $blog) :?>
                    <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#moll<?=$blog['id']?>">
                        <a style="text-decoration:none; color:white;"href="<?=BASE_URL;?>/siswa/detail/<?=$blog['id']?>">Detail</a>
                        </button>
                        ...
                        <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            ...
                            <a href="<?= BASE_URL; ?>/siswa/hapus/<?= $blog['id']?> " onclick="return confirm('Yakin?');" class="btn btn-success mr-2">hapus</a>
