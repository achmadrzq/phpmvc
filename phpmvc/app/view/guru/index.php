 ...
 <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-success mr-2" <?=$blog['id']?>>
                          <a style="text-decoration:none; color:white;"href="<?=BASE_URL;?>/guru/detail/<?=$blog['id']?>">Detail</a>
                        </button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="form-group">
                                <label for="pelajaran" >Matpel</label>
                        ...
                        <button type="button" class="btn btn-success mr-2" data-toggle="modal" data-target="#exampleModal<?=$blog['id']?>">
                            ...
                            <a href="<?= BASE_URL; ?>/guru/hapus/<?= $blog['id']?> " onclick="return confirm('Yakin?');" class="btn btn-success mr-2">hapus</a>
